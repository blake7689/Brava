...
{
    public class StaticContentMocks
    {
        public static Dictionary<string, string> GetHomeContent()
        {
        ...
        public static Dictionary<string, string> GetScienceContent()
        {
        ...
        public static Dictionary<string, string> GetOurStoryContent()
        {
        ...
        public static Dictionary<string, string> GetPrivacyContent()
        {
        ...
        public static Dictionary<string, string> GetTermsContent()
        {
